...
const sections = [
  ...
  { title: "Test Management", items: [{ href: "/requirements", icon: "≡", label: "Requirements" }, { href: "#", icon: "✓", label: "Test Cases", disabled: true }, { href: "#", icon: "▶", label: "Test Execution", disabled: true }, { href: "#", icon: "●", label: "Bugs", disabled: true }] },
