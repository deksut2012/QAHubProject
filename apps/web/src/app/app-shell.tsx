...
const sections = [
  ...
  { title: "Test Management", items: [{ href: "/requirements", icon: "≡", label: "Requirements" }, { href: "/test-cases", icon: "✓", label: "Test Cases" }, { href: "#", icon: "▶", label: "Test Execution", disabled: true }, { href: "#", icon: "●", label: "Bugs", disabled: true }] },
