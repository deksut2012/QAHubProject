...
const sections = [
  ...
  { title: "Test Management", items: [{ href: "#", icon: "≡", label: "Requirements", disabled: true }, { href: "#", icon: "✓", label: "Test Cases", disabled: true }, { href: "#", icon: "▶", label: "Test Execution", disabled: true }, { href: "#", icon: "●", label: "Bugs", disabled: true }] },
